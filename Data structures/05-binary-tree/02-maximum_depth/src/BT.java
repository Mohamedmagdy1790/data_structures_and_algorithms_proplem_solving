public class BT<T extends  Comparable<T>> {
   ...
   public Node root ;
    ...
    public int depth(Node temp){
        ...
        int maxleft=depth(temp.getLeft());
        int maxright=depth(temp.getRight());
        int max= maxOfLeftAndRight(maxleft,maxright);
        //this is the most important point
        //every return will add 1
      return max+1;
    }

    private int maxOfLeftAndRight(int maxleft, int maxright) {
